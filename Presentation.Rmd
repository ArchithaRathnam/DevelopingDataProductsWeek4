...
3. The GitHub repository containing the R codes required to build the Shiny App (**server.R** and **ui.R**)can be accessed [here](https://github.com/ArchithaRathnam/DevelopingDataProductsWeek4)
2. The Shiny app can be accessed [here](https://architharathnam.shinyapps.io/DevelopingDataProductsWeek4/), which contains
